...
#ggsn package 
#Adds north symbols and scale bars for maps created with 'ggmap' and 'ggplot'.
...
#Allows scale bar to be customized such as the legend colour, bar fix colour and text colour, font and size.
#Can change the position and the size of north symbol and scale bar.

#scale package
#Graphical scales map data to aesthetics, and provide methods for automatically determining breaks and labels for axes and legends.
#The scale package is composed of interdependent components such as palettes, transformations, bounds, scaling functions and mutables ranges.
